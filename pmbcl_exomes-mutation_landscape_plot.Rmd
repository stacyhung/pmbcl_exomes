...
# plot VAF for top recurrently mutated genes (n=73)
vafPlot <- plotVaf(maf = mutations.maf, genes = supptable2$gene_hugo, vafCol = 'VAF', showN = FALSE)

# Plotting VAF for the union of MutSig and recurrently mutated genes (n=101)
...
supptable2.not_MutSig <- subset(supptable2, !(supptable2$significant == 'y'))
vafPlot <- plotVaf(maf = mutations.maf, genes = supptable2.not_MutSig$gene_hugo, vafCol = 'VAF', showN = FALSE)
